...
// Clientes activos
$sql = "SELECT * FROM ClientesRegistrados WHERE Estado='Activo' ORDER BY Nombre";
...
$html.='<h1>Clientes Activos</h1></div><table><thead><tr>
...
if($result->num_rows>0){
    ...
    $html.='<tr><td colspan="11">No hay clientes activos</td></tr>';
}
...
$dompdf->render();
$dompdf->stream("ClientesActivos.pdf",["Attachment"=>false]);
