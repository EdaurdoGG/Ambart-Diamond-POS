...
// Empleados activos
$sql = "SELECT * FROM EmpleadosRegistrados WHERE Estado = 'Activo' ORDER BY Nombre";
...
$html .= '<h1>Empleados Activos</h1></div>
<table>
<thead>
<tr>
...
if ($result->num_rows > 0) {
    ...
    $html .= '<tr><td colspan="10">No hay empleados activos</td></tr>';
}
...
$dompdf->render();
$dompdf->stream("EmpleadosActivos.pdf", ["Attachment" => false]);
