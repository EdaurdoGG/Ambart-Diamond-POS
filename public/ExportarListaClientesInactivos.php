...
// Clientes inactivos
$sql = "SELECT * FROM ClientesRegistrados WHERE Estado='Inactivo' ORDER BY Nombre";
...
if($logoBase64) $html.='<img src="'.$logoBase64.'" alt="Logo">';
$html.='<h1>Clientes Inactivos</h1></div><table><thead><tr>
...
if($result->num_rows>0){
    ...
    $html.='<tr><td colspan="11">No hay clientes inactivos</td></tr>';
}
...
$dompdf->render();
$dompdf->stream("ClientesInactivos.pdf",["Attachment"=>false]);
